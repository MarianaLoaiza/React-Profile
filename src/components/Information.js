                ...
                <div className="column ">
                    ...
                    <div className="col-12 d-flex justify-content-center">
                        <section className="information__me">
                            ...
                            <p className="information___paragraph">Actualmente estoy estudiando en el bootcamp de Academia Geek con énfasis en desarrollo Front-End. Cuento con conocimientos básicos en JS, React.js y Java. <br/> <br/>
